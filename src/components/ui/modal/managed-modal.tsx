...
const UpdateProductConfirmView = dynamic(
  () => import("@components/product/update-product-confirm-view")
);
...
const PublishProductView = dynamic(
  () => import("@components/product/publish-product-modal")
);

const AddCategoryView = dynamic(
  () => import("@components/category/add-category-modal")
);

const AddTagView = dynamic(
  () => import("@components/tag/add-tag-modal")
);

const AddUnitView = dynamic(
  () => import("@components/unit/add-unit-modal")
);
...
const ManagedModal = () => {
  ...
  return (
    <Modal open={isOpen} onClose={closeModal}>
      ...
      {view === "UPDATE_PRODUCT_CONFIRM" && <UpdateProductConfirmView />}
      ...
      {view === "PUBLISH_PRODUCT" && <PublishProductView />}
      {view === "ADD_CATEGORY" && <AddCategoryView />}
      {view === "ADD_TAG" && <AddTagView />}
      {view === "ADD_UNIT" && <AddUnitView />}
